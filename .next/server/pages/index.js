...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://siddhanth:12345@cluster0.n1ehjhy.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); //useEffect works such a way that it executes after the component function executes
